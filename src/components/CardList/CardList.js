...
import airbnbLogo from '../../images/cardlist_airbnb-logo.svg';
import bookingLogo from '../../images/cardlist_booking-logo.svg';
        ...
        <section className="card-list">
            ...
            {selectedCards.map((state)=>{
                ...
                <div key={JSON.stringify(state)}>
                    <a className="card-list__name" href={state.url} target="_blank" rel="noreferrer">{state.name}</a>
